...
import { ShiftPosition } from './pipes/shift-pipe';
...
@NgModule({
  imports: [...MODULES],
  declarations: [ACLComponent, PhoneMaskDirective, OnlyNumbersDirective, TwoDigitDecimalNumberDirective, AppDateFormatPipe, CopypasteBlockDirective,ThousandSuffixesPipe,ShiftPosition],
  exports: [...MODULES, PhoneMaskDirective, OnlyNumbersDirective, TwoDigitDecimalNumberDirective, AppDateFormatPipe , CopypasteBlockDirective,ThousandSuffixesPipe,ShiftPosition],
})
