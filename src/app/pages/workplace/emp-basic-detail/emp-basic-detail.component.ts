...
@Component({
  selector: 'app-emp-basic-detail',
  templateUrl: './emp-basic-detail.component.html',
  styleUrls: ['./emp-basic-detail.component.scss']
})
export class EmpBasicDetailComponent implements OnInit {
